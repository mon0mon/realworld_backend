...
public class TestConstant {
  ...
  public static final String REGISTER_EMAIL = "user2@example.com";
  public static final String REGISTER_USERNAME = "user2";
  public static final String REGISTER_PASSWORD = "123";
  public static final String UPDATE_EMAIL = "user1_change@example.com";
  public static final String UPDATE_USERNAME = "user1_change";
